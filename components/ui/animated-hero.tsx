      ...
      <div className="container mx-auto">
        <div className="flex gap-8 py-6 items-center justify-center flex-col">
          ...
          <div className="flex gap-4 flex-col">
            <h1 className="!text-5xl !md:text-7xl max-w-2xl tracking-tighter text-center font-regular" style={{fontSize: '48px'}}>
            ...
            <p className="!text-[16px] !md:text-xl leading-relaxed tracking-tight text-muted-foreground max-w-2xl text-center" style={{fontSize: '16px'}}>
