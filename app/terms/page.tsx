  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 md:px-8">
      ...
      <div className="prose prose-lg max-w-[900px] mx-auto pb-20 [&>h2]:mt-8 [&>h2]:mb-4 [&>h2]:text-3xl [&>h2]:font-bold [&>h3]:mt-4 [&>h3]:mb-4 [&>p]:my-4 text-left">
        ...
        <h3 className="uppercase">CHANGES TO SERVICES</h3>
        <p>
        ...
        <h3 className="uppercase">SUSPENSION OF THE SERVICE</h3>
        <p>
        ...
        <h3 className="uppercase">VALID CONTACT INFORMATION</h3>
        <p>
        ...
        <h3 className="uppercase">HUMAN CUSTOMER</h3>
        <p>
        ...
        <h3 className="uppercase">EXPLOIT</h3>
        <p>
        ...
        <h3 className="uppercase">CUSTOMER INFORMATION</h3>
        <p>
        ...
        <h3 className="uppercase">EXTRA SERVICE FEES</h3>
        <p>
        ...
        <h3 className="uppercase">PRICE CHANGES</h3>
        <p>
        ...
        <h3 className="uppercase">TERMINATION</h3>
        <p>
        ...
        <h3 className="uppercase">CHANGES TO TOS</h3>
        <p>
        ...
        <h3 className="uppercase">USE OF CUSTOMER&apos;S NAME AND COMPANY NAME</h3>
        <p>
          Intro reserves the right to use the Customer&apos;s name and/or company name as a reference for marketing or promotional purposes on the Intro.io website and other communication with existing or potential Intro customers. To decline Intro this right the Customer needs to email hi@intro.io stating the wish not to be used as a reference or any similar purpose.
        </p>

        <h2>Intellectual Property</h2>
        <h3 className="uppercase">COPYRIGHT INFRINGEMENT</h3>
        <p>
        ...
        <h3 className="uppercase">ASSIGNMENT</h3>
        <p>
        ...
        <h2>Other</h2>
        <h3 className="uppercase">ENTIRE AGREEMENT</h3>
        <p>
        ...
        <h3 className="uppercase">PRECEDENCE</h3>
        <p>
        ...
        <h3 className="uppercase">FORCE MAJEURE</h3>
        <p>
        ...
        <h3 className="uppercase">INDEPENDENT CONTRACTORS</h3>
        <p>
        ...
        <h3 className="uppercase">WARRANTIES</h3>
        <p>
        ...
        <p>
          The Customer represents and warrants that the Customer&apos;s use of the Service will be in strict accordance with the Intro Privacy Policy, with this Agreement and with all applicable laws and regulations (including without limitation any local laws or regulations in your country, state, city, or other governmental area).
        </p>

        <h3 className="uppercase">EMBARGOES</h3>
        <p>
        ...
        <h3 className="uppercase">LIABILITY</h3>
        <p>
        ...
        <h3 className="uppercase">RESPONSIBILITY OF DECISIONS</h3>
        <p>
        ...
        <h3 className="uppercase">DAMAGE AND LOSSES</h3>
        <p>
        ...
        <h3 className="uppercase">INDEMNIFICATION</h3>
        <p>
        ...
        <h2>Dispute</h2>
        <h3 className="uppercase">GOVERNED LAW</h3>
        <p>
        ...
        <p>
          If you have any questions about these Terms of Service or any other question, please contact us at hi@intro.io or send a mail to Introfied AB, c/o Kivra: 556847-3432, 106 31 Stockholm, Sweden.
        </p>
      </div>
    </div>);
